...
{
    /// <inheritdoc />
    public partial class CreateAcademicStructure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_academic_years_courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_lesson_progress_users_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_academic_years_CourseId_YearNumber",
                table: "academic_years",
                columns: new[] { "CourseId", "YearNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_lesson_progress_StudentId",
                table: "lesson_progress",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_lessons_SubjectId_Position",
                table: "lessons",
                columns: new[] { "SubjectId", "Position" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_semesters_AcademicYearId_SemesterNumber",
                table: "semesters",
                columns: new[] { "AcademicYearId", "SemesterNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_subjects_SemesterId_Name",
                table: "subjects",
